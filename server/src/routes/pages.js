...
export default (prisma) => {
  ...
  const STATIC_PAGES = [
    ...
    { id: '/dashboard', name: 'Kullanıcı Paneli' },
    { id: '/faq', name: 'SSS' },
    { id: '/lead/:id', name: 'Lead Detayı' },
    { id: '/leads', name: 'Lead Pazarı' },
    { id: '/profile', name: 'Profil' },
    { id: '/purchased-leads', name: 'Satın Aldıklarım' },
    { id: '/admin/about', name: 'Hakkında Yönetimi' },
    { id: '/admin/activity-log', name: 'Aktivite Kaydı' },
    { id: '/admin/design-settings', name: 'Tasarım Ayarları' },
    { id: '/admin/email-sms-settings', name: 'E-posta & SMS Ayarları' },
    { id: '/admin/faq', name: 'FAQ Yönetimi' },
    { id: '/admin/homepage-settings', name: 'Anasayfa Ayarları' },
    { id: '/admin/lead-type-permissions', name: 'Lead Tipi Yetkileri' },
    ...
    { id: '/admin/statistics', name: 'İstatistikler' },
    { id: '/admin/user-types', name: 'Kullanıcı Tipleri' },
    { id: '/admin/users', name: 'Kullanıcı Yönetimi' },
  ]
