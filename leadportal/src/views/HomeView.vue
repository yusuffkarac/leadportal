  ...
  try {
    ...
    homepageContent.value = {
      hero: { 
        ...
        ...(data.hero || {}),
        backgroundImage: data.hero?.backgroundImage ?? defaultHomepageContent.hero.backgroundImage,
        backgroundOpacity: data.hero?.backgroundOpacity ?? defaultHomepageContent.hero.backgroundOpacity
      },
    ...
    <section 
      ...
      :style="{
        backgroundImage: hero.backgroundImage 
          ...
          : 'url(/images/mainHandshake.jpg)'
      }"
    >
      <div 
        class="hero-overlay"
        :style="{
          opacity: 1 - (hero.backgroundOpacity ?? 0.75)
        }"
      ></div>
