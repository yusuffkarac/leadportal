...
import AdminCustomPagesView from '../views/AdminCustomPagesView.vue'
...
export const appRoutes = [
    ...
    },
    {
      ...
      component: AdminCustomPagesView,
      meta: { requiresAdmin: true },
    },
    {
      path: '/:slug',
...
router.beforeEach(async (to, from, next) => {
  ...
  try {
    ...
    // Custom page kontrolü - public erişim
    if (to.matched.some(r => r.meta && r.meta.isCustomPage)) {
      console.log('Custom page access - allowing:', to.path)
      next()
      return
    }
